...
const Login = () => {
    ...
    return (
        <div className='object-contain w-full ' style={{ backgroundImage: ` url('https://thumbs.dreamstime.com/z/baby-background-pink-color-clothes-booties-accessories-newborn-girl-pink-table-top-down-frame-baby-background-pink-166445309.jpg')` }}>
