...
const Checkout = () => {
  ...
  const saveOrderData = () => {
    const { name, email, city, address } = addressForm.values;
    console.log(addressForm.values);

    const orderData = {
      name: name,
      address: { email, city, address },
      product: product
    }

    axios.post('http://localhost:5000/order/add', orderData)
      .then((response) => {
  ...
  return (
    <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <form onSubmit={addressForm.handleSubmit} className="mx-auto max-w-screen-xl px-4 2xl:px-0">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="LA">Australia</option>
                    <option value="CH">London</option>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="relative w-full">
                      <input
                        ...
                        id="contact"
                        onChange={addressForm.handleChange}
                        value={addressForm.values.contact}
                  ...
                  <div className="flex items-start">
                    <div className="flex h-5 items-center">
                      <input
                        ...
                        name="payment-method"
                        defaultValue=""
                        className="h-4 w-4 border-gray-300 bg-white bg-blue-300 text-primary-600 focus:ring-2 focus:ring-primary-600 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-primary-600"
                        required
                      />
                    </div>
